...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Для получения токена используйте <a href="#avtorizaciia-POSTlogin">эндпоинт для авторизации</a>.',
    ],

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<INTRO
Документация по работе с users-service
INTRO
    ,
    ...
    'last_updated' => 'Обновлено: {date:F j, Y}',
