...
from vitacore_service.adapters.db.departments.departments_converter import department_dto_to_db
...
class DBDepartmentsGateway(DepartmentSaver):
    ...
    async def create_bulk(self, departments: list[DepartmentDTO]) -> None:
        ...
        """
        db_departments = [department_dto_to_db(department) for department in departments]
