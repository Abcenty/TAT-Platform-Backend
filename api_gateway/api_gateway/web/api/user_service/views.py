...
from api_gateway.web.api.user_service.exceptions import AuthorizationError, RegistrationError
from api_gateway.web.api.user_service.schema import Auth, Registration
